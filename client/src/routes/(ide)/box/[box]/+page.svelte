...
{:else}
    ...
    <nav class="bg-orange-rust h-14 md:h-full w-full md:w-14 py-4 px-11 md:px-4 md:pt-16 space-x-8 md:space-x-0 fixed flex md:flex-col items-center justify-between md:justify-start inset-x-0 md:inset-y-0 bottom-0 md:left-0 rounded-t-xl md:rounded-t-none">
        <a href="/" title="Close Editor">
            <button class="group py-4">
                <svg class="fill-gray-200 group-hover:fill-orange-bright transition-colors h-6 w-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                    <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"/>
                </svg>
            </button>
        </a>
        <button on:click={changeTheme} class="group py-4" title="Change Theme">
            <svg class="fill-gray-200 group-hover:fill-orange-bright transition-colors h-6 w-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                <path d="M8 5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm4 3a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM5.5 7a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm.5 6a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/>
                <path d="M16 8c0 3.15-1.866 2.585-3.567 2.07C11.42 9.763 10.465 9.473 10 10c-.603.683-.475 1.819-.351 2.92C9.826 14.495 9.996 16 8 16a8 8 0 1 1 8-8zm-8 7c.611 0 .654-.171.655-.176.078-.146.124-.464.07-1.119-.014-.168-.037-.37-.061-.591-.052-.464-.112-1.005-.118-1.462-.01-.707.083-1.61.704-2.314.369-.417.845-.578 1.272-.618.404-.038.812.026 1.16.104.343.077.702.186 1.025.284l.028.008c.346.105.658.199.953.266.653.148.904.083.991.024C14.717 9.38 15 9.161 15 8a7 7 0 1 0-7 7z"/>
            </svg>
        </button>
        <button on:click={saveBox} class="group py-4" title="Save Box">
            <svg class="fill-gray-200 group-hover:fill-orange-bright transition-colors h-6 w-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                <path d="M13.5 1a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3zM11 2.5a2.5 2.5 0 1 1 .603 1.628l-6.718 3.12a2.499 2.499 0 0 1 0 1.504l6.718 3.12a2.5 2.5 0 1 1-.488.876l-6.718-3.12a2.5 2.5 0 1 1 0-3.256l6.718-3.12A2.5 2.5 0 0 1 11 2.5zm-8.5 4a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3zm11 5.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3z"/>
            </svg>
        </button>
        <button on:click={downloadBox} class="group py-4" title="Download Box">
            <svg class="fill-gray-200 group-hover:fill-orange-bright transition-colors h-6 w-auto"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
